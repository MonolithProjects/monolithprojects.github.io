...
Since the Fedora upgrade is a ceremony which i am doing every 6 months, and always forget how i did it, it's probably good idea to write it down and create kind of `cheat sheet`.
